...
public class Certificate {
	...
	public static void main(String[] args) {
		...
		NeutronCertificate.NeutronCertificates list = osclient.networking().lbaasV2().lbCertificate().list();
...
//		NeutronCertificate certificate = NeutronCertificate.builder()
//				.name("cert_test")
//				.description("cert for java-sdk")
//				.type("server")
//				.domain("www.elb.com")
//				.privateKey(key)
//				.certificate(cert)
